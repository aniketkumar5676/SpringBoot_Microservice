...
public class Booking {
	...
	int bookHotel(String location, int days, String Userid) {
		...
		// System.out.println("\t\t\t(Availability of" + " Rooms : " + (Radissonroom =
		// new Random().nextInt(0, 4)) + ")");
		...
		// System.out.println("\t\t\t(Availability of" + " Rooms : " + (Holidayroom =
		// new Random().nextInt(0, 4)) + ")");
		...
		// System.out.println("\t\t\t(Availability of" + " Rooms : " + (Tajroom = new
		// Random().nextInt(0, 4)) + ")");
		...
		// System.out.println("\t\t\t(Availability of" + " Rooms : " + (Ambasroom = new
		// Random().nextInt(0, 4)) + ")");
		...
		// System.out.println("\t\t\t(Availability of" + " Rooms : " + (Prideroom = new
		// Random().nextInt(0, 4)) + ")");
		...
		while (true) {
			...
			case 3: {
				...
				bc.confirmBooking(new TajPalaceHotel(), Userid, location, days);
